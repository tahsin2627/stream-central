...
const Favorites = () => {
      ...
      <Layout>
        <div className="pt-24 pb-16 container mx-auto px-4">
          <div className="max-w-md mx-auto text-center py-16">
            ...
            <h1 className="text-2xl font-bold mb-4">Sign in to access favorites</h1>
            <p className="text-muted-foreground mb-8">
              Create an account to save your favorite movies and shows.
            </p>
  ...
  // Convert favorites to TMDB format for MovieCard
      ...
      <div className="pt-24 pb-16 container mx-auto px-4">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-8">
              Browse movies and shows and tap the heart to add them here.
            </p>
            <Button asChild>
