  ...
  return (
    <Layout>
      ...
      <div className="relative -mt-16 sm:-mt-24 md:-mt-32 z-10 pb-16">
        ...
        <ContentCarousel title="🎥 Bengali Cinema" items={(bengali?.results || []) as TMDBMovie[]} isLoading={bengaliLoading} />
        <ContentCarousel title="📺 Bengali TV Shows" items={(bengaliTV?.results || []) as TMDBTVShow[]} isLoading={bengaliTVLoading} />
