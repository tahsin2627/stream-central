...
import { useTrending, usePopularMovies, useTopRatedMovies, usePopularTVShows, useBollywoodMovies, useKoreanDramas, useBengaliMovies, useBengaliTVShows } from '@/hooks/useTMDB';
